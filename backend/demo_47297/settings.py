"""
Django settings for demo_47297 project.
...
WSGI_APPLICATION = 'demo_47297.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "demo_47297 API",
    "DESCRIPTION": "API documentation for demo_47297 App",
    "VERSION": "v1",
}
